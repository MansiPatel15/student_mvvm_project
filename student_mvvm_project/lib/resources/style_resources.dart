...
class StyleResources
{
  ...
  static Color green1 =  Color(0xFF63C822);
  static Color blackmy =  Color(0xFF333333);
  static Color greymy =  Color(0xFFcccccc);
  //Color(0xFF234f2e) = darkgreen;
  ...
  static TextStyle formlable = TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.w500);
